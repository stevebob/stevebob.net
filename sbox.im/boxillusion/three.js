...
function testShape(world) {
    ...
    addPoint(world, -2, 2, 2); //0
    addPoint(world, 2, 2, 2)   //1
    addPoint(world, 2, -2, 2)  //2
    addPoint(world, -2, -2, 2) //3
    addPoint(world, -2, 2, -2) //4
    addPoint(world, 2, 2, -2)  //5
    addPoint(world, 2, -2, -2) //6
    addPoint(world, -2, -2, -2)//7
