...
function main() {
    ...
    o.points[8] = new Point3D(hallway, 0.5, -1);
    o.points[9] = new Point3D(-hallway, 0.5, -1);
    o.points[10] = new Point3D(hallway, -1, -1);
    o.points[11] = new Point3D(-hallway, -1, -1);
...
//    o.addPolygon(new Polygon3D([1, 5, 7, 3]));
    o.addPolygon(new Polygon3D([1, 5, 9, 8]));
    o.addPolygon(new Polygon3D([1, 8, 10, 3]));
    o.addPolygon(new Polygon3D([5, 7, 11, 9]));
    
    
    
    var o2 = new Object3D();
    o2.currentColour = "rgb(255, 255, 200)";
    o2.points[0] = (new Point3D(1, 1, 1));
    o2.points[1] = (new Point3D(1, 1, -1));
    o2.points[2] = (new Point3D(1, -1, 1));
    o2.points[3] = (new Point3D(1, -1, -1));
    o2.points[4] = (new Point3D(-1, 1, 1));
    o2.points[5] = (new Point3D(-1, 1, -1));
    o2.points[6] = (new Point3D(-1, -1, 1));
    o2.points[7] = (new Point3D(-1, -1, -1));
...
//    o.addPolygon(new Polygon3D([1, 5, 7, 3]));
    ...
    o.turnInsideOut();
    o.basis.uvnMultiplyMatrix(Matrix3D.scaleTransform(50, 20, 60));
    
    o2.turnInsideOut();
    o2.basis.originMultiplyMatrix(Matrix3D.translateTransform(0, -5, -160));
    o2.basis.uvnMultiplyMatrix(Matrix3D.scaleTransform(50 * hallway, 15, 100));

    o.globalize();
    o2.globalize();
    
    o.currentColour = "rgb(200, 255, 255)";
    var o3 = o.applyMatrix(Matrix3D.translateTransform(0, 0, -320).multiplyMatrix(Matrix3D.rotateTransformY(Math.PI)));
