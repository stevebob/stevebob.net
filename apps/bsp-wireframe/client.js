...
//    var o2 = o.applyMatrix(Matrix3D.translateTransform(-20, 0, -20).multiplyMatrix(Matrix3D.translateScale(2, 2, 2)));
    ...
    var o4 = o.applyMatrix(Matrix3D.rotateTransformX(-Math.PI/4).multiplyMatrix(Matrix3D.rotateTransformZ(Math.PI/12)).multiplyMatrix(Matrix3D.translateTransform(0, -5, 0)));
