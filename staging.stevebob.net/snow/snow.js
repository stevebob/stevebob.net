...
function drawFlakes(n, snow) {
    ...
    t=setTimeout(drawFlakes, 1, n, snow);
...
function setUpCanvas() {
    ...
    //getDark();
    //snowFlake(drawArea.width/2, drawArea.height/2);
    trackSurvival();
    snowFall();
