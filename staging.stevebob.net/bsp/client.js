...
function main() {
    ...
    o.points[0] = (new Point3D(5, 5, 5));
    
    o.points[1] = (new Point3D(5, 5, -5));
    o.points[2] = (new Point3D(5, -5, 5));
    o.points[3] = (new Point3D(5, -5, -5));
    o.points[4] = (new Point3D(-5, 5, 5));
    o.points[5] = (new Point3D(-5, 5, -5));
    o.points[6] = (new Point3D(-5, -5, 5));
    o.points[7] = (new Point3D(-5, -5, -5));
...
//    var o2 = o.applyMatrix(Matrix3D.translateTransform(-20, 0, -20).multiplyMatrix(Matrix3D.translateScale(2, 2, 2)));
    var o2 = new Object3D();
    //var o3 = o.applyMatrix(Matrix3D.rotateTransformX(-Math.PI/12));
    o2.points[0] = (new Point3D(10, 10, 10));
    o2.points[1] = (new Point3D(10, 10, -10));
    o2.points[2] = (new Point3D(10, -10, 10));
    o2.points[3] = (new Point3D(10, -10, -10));
    o2.points[4] = (new Point3D(-10, 10, 10));
    o2.points[5] = (new Point3D(-10, 10, -10));
    o2.points[6] = (new Point3D(-10, -10, 10));
    o2.points[7] = (new Point3D(-10, -10, -10));

    o2.addPolygon(new Polygon3D([0, 1, 3, 2]));
    o2.addPolygon(new Polygon3D([4, 6, 7, 5]));
    o2.addPolygon(new Polygon3D([0, 4, 5, 1]));
    o2.addPolygon(new Polygon3D([2, 3, 7, 6]));
    o2.addPolygon(new Polygon3D([0, 2, 6, 4]));
    o2.addPolygon(new Polygon3D([1, 5, 7, 3]));
    var o3 = o2.applyMatrix(Matrix3D.translateTransform(20, 0, 0));

    var o4 = o.applyMatrix(Matrix3D.rotateTransformX(-Math.PI/4).multiplyMatrix(Matrix3D.rotateTransformZ(Math.PI/12)).multiplyMatrix(Matrix3D.translateTransform(-5, 0, 0)));
