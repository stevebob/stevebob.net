...
$ ->
    ...
    s1 = $S4D(($V [0, 0, 0, 0.9]), ($V [1, 0, 0, 0]), ($V [0, 1, 0, 0]), ($V [0, 0, 1, 0]))
...
class Avatar
  ...
  move: ->
    ...
    if @turnPosXW
      s1.rotateXW(Math.PI/36)
    
    if @turnNegXW
      s1.rotateXW(-Math.PI/36)
    
    if @turnPosYW
      s1.rotateYW(Math.PI/36)
    
    if @turnNegYW
      s1.rotateYW(-Math.PI/36)
    
    if @turnNegZW
      s1.rotateZW(-Math.PI/36)
    
    if @turnPosZW
      s1.rotateZW(Math.PI/36)

    if @turnPosXY
      s1.rotateXY(Math.PI/36)
    if @turnNegXY
      s1.rotateXY(-Math.PI/36)
    if @turnPosXZ
      s1.rotateXZ(Math.PI/36)
    if @turnNegXZ
      s1.rotateXZ(-Math.PI/36)

    if @turnPosYZ
      s1.rotateYZ(Math.PI/36)
    if @turnNegYZ
      s1.rotateYZ(-Math.PI/36)      
