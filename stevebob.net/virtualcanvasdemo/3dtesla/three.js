function Three() {
    ...
    this.xDir = new Vector3(1, 0, 0);
    this.yDir = new Vector3(0, 1, 0);
    this.zDir = new Vector3(0, 0, 1);

    this.eyeVel = new Vector3(0, 0, 0);
    this.eyeAccel = new Vector3(0.05, 0.05, 0);

    this.maxEyeVel = new Vector3(0.4, 0.4, 0);
...
function addPoint(world, x, y, z) {
    world.point[world.pCount] = new Vector3(x, y, z);
    world.pCount++;
...
function setUpCanvas() {
    ...
    if (drawArea.getContext) {
        ...
        ctx = new SimpleVirtualCanvas(new FullScreenCanvas(drawArea),
                                        100, 50,
                                        100, 100,
                                        0.3, Math.PI/16
                    );
